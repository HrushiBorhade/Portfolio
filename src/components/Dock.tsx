...
export default function Dock() {
  ...
  return (
    <motion.div
      ...
      className="flex items-end h-20 gap-2 px-1 pb-2 mx-auto border border-stone-900 sm:px-3 bg-stone-700/20 -z-10 rounded-2xl backdrop-opacity-100 backdrop-filter backdrop-blur-xl  animate-fade-in [--animation-delay:3500ms] opacity-0 translaye-y-[-10px]"
    >
