...
export const Card: React.FC<PropsWithChildren> = ({ children }) => {
  ...
  return (
    <div
      ...
      className="relative overflow-hidden duration-700 border bg-gradient-to-tl from-zinc-900/0 via-zinc-900 to-zinc-900/0 rounded-xl hover:bg-zinc-800/10 group md:gap-8 hover:border-zinc-400/50 border-zinc-600 "
    >
